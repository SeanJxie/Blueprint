...
To run the program as an executable, [download](https://github.com/SeanJxie/Blueprint/releases/download/v1.1/PythonBlueprint.zip) `PythonBlueprint.zip` in releases, unzip, then find and run the `PythonBlueprint.exe` application.
